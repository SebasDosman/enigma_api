...
public class GetStepApiController implements GetStepApi {
    ...
    public GetStepApiController(RestTemplateService restTemplateService) {
...
//        ResponseEntity<?> stepThree = restTemplateService.postStep("http://localhost:8083/v1/getOneEnigma/getStep", bodyThree);
        ...
        responseEnigma.setAnswer(stepOne.getBody().concat(" - ").concat(stepTwo.getBody()).concat(" - ").concat(stepThree.getBody()));
